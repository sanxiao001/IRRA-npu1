...
def get_args():
    ...
    parser.add_argument("--name", default="iira", help="experiment name to save")
    parser.add_argument("--output_dir", default='logs')
    parser.add_argument("--log_period", default=100)
    parser.add_argument("--eval_period", default=1)
    parser.add_argument("--val_dataset", default="test") # use val set when evaluate, if test use test set
    parser.add_argument("--resume", default=False, action='store_true')
    parser.add_argument("--resume_ckpt_file", default="logs/CUHK-PEDES/iira_B64_E50/best.pth", help='resume from ...')
    ...
    parser.add_argument("--loss_names", default='itc', help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm', 'cluster']")
