...
def build_transforms(img_size, aug=False, is_train=True):
...
def build_dataloader(args, tranforms=None):
    ...
    # 修改
    # dataset.train = [i[2:4] for i in dataset.train[0:len(dataset.train)]]
    dataset.train = [i[2:4] for i in dataset.train[0:200]]
    ...
    if args.training:
        ...
        return train_loader, val_img_loader, val_txt_loader
...
def build_cluster_dataloader(args, tranforms=None):
    logger = logging.getLogger("IRRA.dataset")
