...
ckpt = torch.load("/home/ma-user/work/IRRA-npu1/model/Meta-Transformer_large_patch14_encoder.pth")


text_tokenier = Data2Seq.Data2Seq(modality='text',dim=512)
image_tokenier = Data2Seq.Data2Seq(modality='image',dim=512)
